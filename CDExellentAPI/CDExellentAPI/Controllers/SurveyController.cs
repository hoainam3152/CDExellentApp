...
namespace CDExellentAPI.Controllers
{
    ...
    {
        private readonly ISurveyRepository service;

        public SurveyController(ISurveyRepository service)
        {
        ...
        [HttpPost]
        public IActionResult Create(SurveyCreate request)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPut]
        public IActionResult Update(int id, SurveyUpdate request)
        {
            if (ModelState.IsValid)
            {
                try
