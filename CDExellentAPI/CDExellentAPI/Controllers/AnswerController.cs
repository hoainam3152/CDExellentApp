...
namespace CDExellentAPI.Controllers
{
    ...
    {
        private readonly IAnswerRepository service;

        public AnswerController(IAnswerRepository service)
        {
        ...
        [HttpPost]
        public IActionResult Create(AnswerCreate request)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPut]
        public IActionResult Update(int id, AnswerUpdate request)
        {
            if (ModelState.IsValid)
            {
                try
