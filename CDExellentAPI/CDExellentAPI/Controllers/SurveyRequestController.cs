...
namespace CDExellentAPI.Controllers
{
    ...
    public class SurveyRequestController : BaseController 
    {
        private readonly ISurveyRequestRepository service;

        public SurveyRequestController(ISurveyRequestRepository service)
        {
        ...
        [HttpPost]
        public IActionResult Create(SurveyRequestCU request)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPut]
        public IActionResult Update(int id, SurveyRequestCU request)
        {
            if (ModelState.IsValid)
            {
                try
