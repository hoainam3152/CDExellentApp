...
namespace CDExellentAPI.Controllers
{
    ...
    {
        private readonly IModuleRepository service;

        public ModuleController(IModuleRepository service)
        {
        ...
        [HttpPost]
        public IActionResult Create(ModuleRequest request)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPut]
        public IActionResult Update(int id, ModuleRequest request)
        {
            if (ModelState.IsValid)
            {
                try
